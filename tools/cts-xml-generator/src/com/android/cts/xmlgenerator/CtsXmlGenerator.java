...
public final class CtsXmlGenerator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final Set<File> expectationFiles = new HashSet<>();
        ...
        if (manifestFile != null) {
            var manifest = DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(manifestFile);
            var documentElement = manifest.getDocumentElement();
        ...
        var store = ExpectationStore.parse(expectationFiles, ModeId.DEVICE);
        var generator = new XmlGenerator(
            store, appNameSpace, appPackageName,
    ...
    private static String getElementAttribute(Element parentElement, String elementName, String attributeName) {
        var nodeList = parentElement.getElementsByTagName(elementName);
