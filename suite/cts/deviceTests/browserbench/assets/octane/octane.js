...
function Run() {
    ...
    var anchor = element('run-octane');
    var parent = element('main-container');
...
Object.assign(window, { AddError: AddError, AddResult: AddResult, AddScore: AddScore,
    CheckCompatibility: CheckCompatibility, Load: Load, Run: Run, ShowBox: ShowBox });
